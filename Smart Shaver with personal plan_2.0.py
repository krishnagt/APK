...
#              'com.philips.platform.lumea&appid=4974925465408706761','com.philips.vitaskin.male&appid=4972357852745218242', 'com.philips.cl.di.figaro&appid=4976268014315616634',
...
# Smart Shaver with personal plan
packageid = 'com.philips.vitaskin.male&appid=4972357852745218242'
...
if(totalcrashes!=str('0')):
    ...
    tc = int(totalcrashes)
    #storing in folder
    directoryname = appname+'_'+currentmonth+'- 2018'
    ...
    for i in range(tc):
        ...
        while True:
            ...
            if (str(num1).strip('[]').strip("''") == str(num2).strip('[]').strip("''")):
                #str(counter)== str('2')
